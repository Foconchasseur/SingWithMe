...
class DownloadViewModel(private val context: Context) : ViewModel() {
     ...
     */
    fun downloadAndSerializeSong(id: ID, errorViewModel: ErrorViewModel, songsList: MutableState<List<Song>>) {
     ...
     */
    fun deleteDownloadedFiles(context: Context, fileName: String, id: ID, songsList: MutableState<List<Song>>) {
