package fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI
...
class KaraokeApplication : Application() {
    companion object {
         ...
         */
        lateinit var instance: fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.KaraokeApplication
            private set
    }
    ...
    override fun onCreate() {
        super.onCreate()
        fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.KaraokeApplication.Companion.instance = this
    }
}
