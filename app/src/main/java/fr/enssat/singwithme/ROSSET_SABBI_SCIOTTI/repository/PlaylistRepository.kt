package fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.repository
...
class PlaylistRepository(private val context: Context) {
    ...
    private val musicJsonUrl = fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.objects.Constants.SERVER_URL + "/playlist.json"
     ...
     */
    suspend fun downloadPlaylist(errorViewModel: ErrorViewModel, songsList: MutableState<List<fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.models.Song>>) {
        if (!cacheFile.exists()) {
     ...
     * @param songsList État mutable contenant la liste des chansons.
     */
    private suspend fun firstDownloadPlaylist(errorViewModel: ErrorViewModel, songsList: MutableState<List<fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.models.Song>>) {
        ...
        withContext(Dispatchers.IO) {
            try {
                ...
                if (response.isSuccessful) {
                    val inputJson = response.body?.string().orEmpty()
                    val json = transformJsonArray(inputJson)
                    val type = object : TypeToken<List<fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.models.Song>>() {}.type
                    val newSongs = Gson().fromJson<List<fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.models.Song>>(json, type)
     ...
     */
    private fun deserializeMusicData(json: String, songsList: MutableState<List<fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.models.Song>>?) {
        val type = object : TypeToken<List<fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.models.Song>>() {}.type
        val songs = Gson().fromJson<List<fr.enssat.singwithme.ROSSET_SABBI_SCIOTTI.models.Song>>(json, type)
